export const CompoundGovernorAbi = [
  ...
  { inputs: [], name: "GovernorDisabledDeposit", type: "error" },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "usedVotes", type: "uint256" },
      { internalType: "uint256", name: "remainingWeight", type: "uint256" },
    ],
  ...
  { inputs: [], name: "ProposalIdAlreadySet", type: "error" },
  {
    inputs: [
      { internalType: "address", name: "proposer", type: "address" },
      { internalType: "uint256", name: "proposalId", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint96",
        name: "oldProposalGuardianExpiry",
        type: "uint96",
      },
      {
        indexed: false,
      ...
      },
      {
        indexed: false,
        internalType: "uint96",
        name: "newProposalGuardianExpiry",
        type: "uint96",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "uint48", name: "_initialVotingDelay", type: "uint48" },
      { internalType: "uint32", name: "_initialVotingPeriod", type: "uint32" },
      {
        internalType: "uint256",
        name: "_initialProposalThreshold",
        type: "uint256",
      },
      { internalType: "contract IComp", name: "_compAddress", type: "address" },
      ...
      { internalType: "uint48", name: "_initialVoteExtension", type: "uint48" },
      { internalType: "address", name: "_whitelistGuardian", type: "address" },
      {
        components: [
          { internalType: "address", name: "account", type: "address" },
          { internalType: "uint96", name: "expiration", type: "uint96" },
        ],
        internalType: "struct CompoundGovernor.ProposalGuardian",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "latestProposalId", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_voteStart", type: "uint256" }],
    name: "quorum",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint48", name: "newVoteExtension", type: "uint48" },
    ],
