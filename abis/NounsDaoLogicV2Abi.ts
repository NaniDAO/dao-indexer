export const NounsDaoLogicV2Abi = [
  ...
  { inputs: [], name: "CantCancelExecutedProposal", type: "error" },
  { inputs: [], name: "CantVetoExecutedProposal", type: "error" },
  { inputs: [], name: "InvalidMaxQuorumVotesBPS", type: "error" },
  { inputs: [], name: "InvalidMinQuorumVotesBPS", type: "error" },
  { inputs: [], name: "MinQuorumBPSGreaterThanMaxQuorumBPS", type: "error" },
  { inputs: [], name: "PendingVetoerOnly", type: "error" },
  { inputs: [], name: "UnsafeUint16Cast", type: "error" },
  { inputs: [], name: "VetoerBurned", type: "error" },
  { inputs: [], name: "VetoerOnly", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
